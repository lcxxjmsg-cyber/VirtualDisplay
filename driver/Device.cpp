 ...
 * SDR | HDR | ST 2084 | HLG) is what makes Display Settings and
 * DISPLAYCONFIG report highDynamicRangeSupported. An EDID-less monitor is
 * always treated as SDR-only, so the driver must provide this descriptor
 * for console HDR.
 *
 ...
 * audio, video, YCbCr 4:2:0, colorimetry and HDR static metadata blocks
 * (MaxCLL ~3806 nits, MaxFALL ~3806 nits) plus detailed timing descriptors.
...
static constexpr BYTE VIRTUALDISPLAY_EDID[256] = {
  ...
  0xE4, 0x0F, 0x18, 0x00, 0x00, 0xE6, 0x06, 0x0F,
  0x01, 0xC8, 0xC8, 0x00, 0x00, 0x00, 0x00, 0x00,
